...
The core hook compiles to just 1.04 kB min+gzip. Zero runtime dependencies. ESM-only with `sideEffects: false`. This makes it one of the smallest React hooks in the ecosystem.

| Entry Point | Min+Gzip |
|------------|----------|
| Main hook | 1.04 kB |
| Worker addon | 1.32 kB |
| Core | 363 B |
| Server entry | 121 B |
| Shim | 531 B |
...
- [Open issues](https://github.com/ABCrimson/use-resize-observer/issues) for bugs
- [Start discussions](https://github.com/ABCrimson/use-resize-observer/discussions) for feature requests
